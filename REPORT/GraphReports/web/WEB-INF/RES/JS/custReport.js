        ...
        var x = {
            ...
            click: function (e) {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json",
                    url: "v1/web/customers/items/" + year + "/read",
...
//                        yValueFormatString: "#0.#,,. Million",
                        ...
                        click: function (e) {
                            var inputData = {
                                "customers": e.dataPoint.indexLabel,
                                "month": $('#monthList').val()
                            };
                            var year = $('#yearList').val();
                            $.ajax({
...
function printData()
{
    ...
    mywindow.document.write('<html><head><title>Customer Report - Print</title>');
