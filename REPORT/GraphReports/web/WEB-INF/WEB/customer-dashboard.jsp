<%-- 
    ...
    Created on : Sep 11, 2016, 5:31:47 PM
        ...
        <div class="navbar-fixed-top">
            <div class="top-br">
                <div class="container-fluid">
                    <div class="btn-top selectedDashboardbtn">Customer DashBoard</div>
            ...
            <div class="top-bar">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <select class="selectpicker1" id="list" multiple data-live-search="true">
